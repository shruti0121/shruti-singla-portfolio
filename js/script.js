        ...
        var r = function() {
            ...
            function i(t) {
                ...
                t.addEventListener("click", function(e) {
                    return w.keyboard && (e.metaKey || e.ctrlKey) ? y.open(t.src, "_blank") : void function(e) {
                        if (w.target = e,
                        w.target.classList.contains("lightense-open"))
                            return a();
                        r("beforeShow"),
                        w.scrollY = y.scrollY,
                        function(n, r, i) {
                        ...
                        }(w.target, "transitionend", function() {
                            r("afterShow")
                        });
                        var t = new Image;
                        t.onload = function() {
                            !function(e) {
                                var t = e.width
                                  ...
                                  , o = w.target.getBoundingClientRect()
                                  , a = t / o.width
                                  , c = y.innerWidth || v.documentElement.clientWidth || 0
                                  , s = y.innerHeight || v.documentElement.clientHeight || 0
                                  , l = w.target.getAttribute("data-lightense-padding") || w.target.getAttribute("data-padding") || w.padding
                                  , d = l < c ? c - l : c - k.padding
                                  , u = l < s ? s - l : s - k.padding
                                  , g = t / n
                                  , f = d / u;
                                w.scaleFactor = t < d && n < u ? a : g < f ? u / n * a : d / t * a;
                                var p = c / 2
                                  , b = r + s / 2
                                  , h = o.left + i + o.width / 2
                                  , m = o.top + r + o.height / 2;
                                w.translateX = Math.round(p - h),
                                w.translateY = Math.round(b - m)
                            }(this),
                            function() {
                                w.target.classList.add("lightense-open"),
                                w.wrap = v.createElement("div"),
                                w.wrap.className = "lightense-wrap",
                                setTimeout(function() {
                                    w.target.style.transform = "scale(" + w.scaleFactor + ")"
                                }, 20),
                                w.target.parentNode.insertBefore(w.wrap, w.target),
                                w.wrap.appendChild(w.target),
                                setTimeout(function() {
                                    w.wrap.style.transform = "translate3d(" + w.translateX + "px, " + w.translateY + "px, 0)"
                                }, 20);
                                var e = {
                                    cubicBezier: w.target.getAttribute("data-lightense-cubic-bezier") || w.cubicBezier,
                                    background: w.target.getAttribute("data-lightense-background") || w.target.getAttribute("data-background") || w.background,
                                    zIndex: w.target.getAttribute("data-lightense-z-index") || w.zIndex
                                }
                                  , t = l(l({}, w), e);
                                o("lightense-images-css-computed", "\n    :root {\n      --lightense-z-index: ".concat(t.zIndex - 1, ";\n      --lightense-backdrop: ").concat(t.background, ";\n      --lightense-duration: ").concat(t.time, "ms;\n      --lightense-timing-func: ").concat(t.cubicBezier, ";\n    }")),
                                w.container.style.visibility = "visible",
                                setTimeout(function() {
                                    w.container.style.opacity = "1"
                                }, 20)
                            }(),
                            y.addEventListener("keyup", s, !1),
                            y.addEventListener("scroll", c, !1),
                            w.container.addEventListener("click", a, !1)
                        }
                        ,
                        t.src = w.target.src
                    }(this)
            ...
            function a() {
                r("beforeHide"),
                y.removeEventListener("keyup", s, !1),
                y.removeEventListener("scroll", c, !1),
                w.container.removeEventListener("click", a, !1),
                w.target.classList.remove("lightense-open"),
                w.wrap.style.transform = "",
                w.target.style.transform = "",
                w.target.classList.add("lightense-transitioning"),
                w.container.style.opacity = "",
                setTimeout(function() {
                    r("afterHide"),
                    w.container.style.visibility = "",
                    w.container.style.backgroundColor = "",
                    w.wrap.parentNode.replaceChild(w.target, w.wrap),
                    w.target.classList.remove("lightense-transitioning")
                }, w.time)
            }
            function c() {
                Math.abs(w.scrollY - y.scrollY) >= w.offset && a()
            }
            function s(e) {
                e.preventDefault(),
                27 === e.keyCode && a()
...
!function(e, t) {
    ...
    function t() {
        ...
        for (var i = Array(e), o = 0, t = 0; t < n; t++)
            for (var r = arguments[t], f = 0, d = r.length; f < d; f++,
            o++)
                i[o] = r[f];
        return i
    }
    return function(e, s) {
        return void 0 === s && (s = "js-reframe"),
        ("string" == typeof e ? t(document.querySelectorAll(e)) : "length"in e ? t(e) : [e]).forEach(function(e) {
            var t, n, i, o, r, f, d, l;
            -1 !== e.className.split(" ").indexOf(s) || -1 < e.style.width.indexOf("%") || (i = e.getAttribute("height") || e.offsetHeight,
...
/* tiny-slider
   ====================================================
   Version : 2.9.3
   Website : http://ganlanyuan.github.io/tiny-slider/demo
        ...
        if (!("scrollBehavior"in e.documentElement.style && !0 !== l.__forceSmoothScrollPolyfill__)) {
            ...
            d.prototype.scrollIntoView = function() {
                if (!0 !== i(arguments[0])) {
                    ...
                    o !== e.body ? (p.call(this, o, o.scrollLeft + r.left - t.left, o.scrollTop + r.top - t.top),
                    "fixed" !== l.getComputedStyle(o).position && l.scrollBy({
                        left: t.left,
                        top: t.top,
                        behavior: "smooth"
                    })) : l.scrollBy({
